...
function Linux.Create(config)
    ...
    local Main = Linux.Instance("Frame", {
        Parent = LinuxUI,
        BackgroundColor3 = Color3.fromRGB(0, 0, 139),
        BorderColor3 = Color3.fromRGB(255, 255, 255),
        BorderSizePixel = 1,
        Size = uiSize,
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Toggle(config)
            ...
            local GradientFill = Linux.Instance("UIGradient", {
                Parent = ToggleFill,
                Color = ColorSequence.new({
                    ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 120, 255)),
                    ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 0, 139))
        ...
        function TabElements.Dropdown(config)
            ...
            local DropGradient = Linux.Instance("UIGradient", {
                Parent = DropFrame,
                Color = ColorSequence.new({
                    ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 120, 255)),
                    ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 0, 139))
                ...
                if IsOpen then
                    for _, opt in pairs(Options) do
                        local OptBtn = Linux.Instance("TextButton", {
                            ...
                            Font = Enum.Font.Gotham,
                            Text = tostring(opt),
                            TextColor3 = opt == SelectedValue and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(200, 200, 200),
                            TextSize = 14,
                        ...
                        OptBtn.MouseButton1Click:Connect(function()
                            ...
                            for _, btn in pairs(DropFrame:GetChildren()) do
                                if btn:IsA("TextButton") then
                                    btn.TextColor3 = btn.Text == tostring(opt) and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(200, 200, 200)
                                end
                            end
            ...
            local function SetValue(value)
                if table.find(Options, value) then
                    ...
                    for _, btn in pairs(DropFrame:GetChildren()) do
                        if btn:IsA("TextButton") then
                            btn.TextColor3 = btn.Text == tostring(value) and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(200, 200, 200)
                        end
                    end
